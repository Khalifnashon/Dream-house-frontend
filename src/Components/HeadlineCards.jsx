    ...
    <div className='max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6'>
      ...
      <div className='rounded-xl relative'>
        ...
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
          <p className='font-bold text-2xl px-2 pt-4'>Rent A Beach House</p>
          <p className='px-2'>Available until 8/26</p>
          <button className='border-white bg-white text-black mx-2 absolute bottom-4'>Check Out</button>
        </div>
        <img
      ...
      <div className='rounded-xl relative'>
        {/* Overlay */}
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
          <p className='font-bold text-2xl px-2 pt-4'>Travel Destinations</p>
      ...
      <div className='rounded-xl relative'>
        {/* Overlay */}
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
          <p className='font-bold text-2xl px-2 pt-4'>Houses All Over Nairobi</p>
